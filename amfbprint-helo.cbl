...
013400***    07/06/16 - AL-01    Copied amfbprint and made changes
      ***                        for HELLO SOCIETY rem records
      ***                        with sig-code = H need to go on invoice
      ***      
...
124100/                                                                 
124200 01  REM-REC.                    COPY AMZRREM.                    
124300/                                                                 
...
al-01      IF WO-PD-FLAG = 'Y'
al-01         DISPLAY 'BLANKING OUT paid flag y'
al-01         MOVE spaces to nt-data-6,
al-01                        nt-data-7,
al-01                        nt-data-8,
al-01                        nt-data-9,
al-01                        nt-data-10.           
...
AL-01*     
AL-01      IF WO-PUB = 'HELO'                                                             
AL-01         PERFORM GET-REMS-HELO.
...
AL-01 * IMPLEMENT HELLO SOCIETY CHANGES
AL-01                         
CTS-02     INITIALIZE NEW-TECH-REC-2                                    
CTS-02     MOVE '2'                    TO NT-CODE-2A                    
CTS-02     MOVE WK-EU-PG-FLG           TO NT-CODE-2B                    
...
AL-01 **NO DESC FOR HELLO SOCIETY               
AL-01      IF WO-PUB = 'HELO'
AL-01         MOVE SPACES TO WK-DIMENSIONS-RE.
201600                                                                  
201700 MOVE-AD-SIZE.                                                    
201800*------------*                                                    
201900                                                                  
...
383600                                                                  
       ...
       acr-include
		   ...
		   or  wk-parm-acr-count = 0
			   display 'include by acr'
      		   Perform release-to-sort
		   end-if	
				
       acr-exclude
           if  wk-parm-acr-march = 'N'
				 display 'bypass by acr'
               Perform release-to-sort
		   end-if
...
AL-01 ******                       
       GET-REMS-HELO. 
            display 'get REMS HELO'.
            MOVE LOW-VALUES            TO REM-KEY                               
            move WO-JOB-NBR            to rem-nbr.                              
            MOVE 'J'                   TO REM-FILE-CODE. 
            MOVE 'A'                   TO REM-TYPE-CODE.
            CALL 'SETL'                USING REM-FILE REM-REC IO-PKT.  
            CALL 'SGET'                USING REM-FILE REM-REC IO-PKT            
            display 'sget 1      ' status-code ' ' rem-nbr                      
                       ' ' rem-text 
            PERFORM Check-Sig-Code UNTIL STATUS-CODE   NOT = 0                                 
                    or WO-JOB-NBR    not = rem-nbr  
                    or REM-FILE-CODE not  = 'J'. 
                    
       Check-Sig-Code.            
            IF  REM-SIG-CODE = 'H' and  WO-JOB-NBR = rem-nbr 
                display rem-nbr ' ' rem-sig-code ' ' rem-text(1:60)
                INITIALIZE NEW-TECH-REC-2                                    
                MOVE '2'                    TO NT-CODE-2A                    
                MOVE WK-EU-PG-FLG           TO NT-CODE-2B                    
                MOVE WK-LINE-CNT            TO NT-JOB-SEQ   
                MOVE '02'                   TO NT-TAB2-P2   
  *******              MOVE '01'                   TO NT-LVL-A                
                ADD  1                      TO WK-LINE-CNT                   
                MOVE WK-LINE-CNT            TO NT-LVL-B
                move rem-text               to nt-data-2                 
                display 'write 5 ' NEW-TECH-REC-2 
                WRITE NEWT-REC FROM Function Upper-case(NEW-TECH-REC-2)
                ADD 1     TO WK-NT-REC-CNT.              
            CALL 'SGET'             USING REM-FILE REM-REC IO-PKT.     
AL-01 ******       